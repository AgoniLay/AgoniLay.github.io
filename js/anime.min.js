...
+ b.duration;
    ...
    }a = void 0 === a ? {} : a; var h, t; var l = 0; var p = null; var m = c(); var g = fa(a); g.reset = function() {
...
= 0; g.progress = 0; g.paused = !0; g.began = !1; g.completed = !1; g.reversed = a === 'reverse'; g.remaining = a === 'alternate' && c === 1 ? 2 : c; b(0); for (a = g.children.length; a--;)g.children[a].reset();
  ...
  } var ga = { update: void 0, begin: void 0, run: void 0, complete: void 0, loop: 1, direction: 'normal', autoplay: !0, offset: 0 }; var S = { duration: 1E3, delay: 0, easing: 'easeOutElastic', elasticity: 500, round: 0 }; var W = 'translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY perspective'.split(' '); var H; var h = { arr: function(a) { return Array.isArray(a); }, obj: function(a) { return Object.prototype.toString.call(a).indexOf('Object') > -1; },
    pth: function(a) { return h.obj(a) && a.hasOwnProperty('totalLength'); }, svg: function(a) { return a instanceof SVGElement; }, dom: function(a) { return a.nodeType || h.svg(a); }, str: function(a) { return typeof a === 'string'; }, fnc: function(a) { return typeof a === 'function'; }, und: function(a) { return typeof a === 'undefined'; }, hex: function(a) { return /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(a); }, rgb: function(a) { return /^rgb/.test(a); }, hsl: function(a) { return /^hsl/.test(a); }, col: function(a) { return h.hex(a) || h.rgb(a) || h.hsl(a); } }; var A = (function() {
    function a(a,
      d, b) { return (((1 - 3 * b + 3 * d) * a + (3 * b - 6 * d)) * a + 3 * d) * a; } return function(c, d, b, f) {
      if (c >= 0 && c <= 1 && b >= 0 && b <= 1) {
        var e = new Float32Array(11); if (c !== d || b !== f) for (var k = 0; k < 11; ++k)e[k] = a(.1 * k, c, b); return function(k) {
          if (c === d && b === f) return k; if (k === 0) return 0; if (k === 1) return 1; for (var h = 0, l = 1; l !== 10 && e[l] <= k; ++l)h += .1; --l; var l = h + (k - e[l]) / (e[l + 1] - e[l]) * .1; var n = 3 * (1 - 3 * b + 3 * c) * l * l + 2 * (3 * b - 6 * c) * l + 3 * c; if (n >= .001) { for (h = 0; h < 4; ++h) { n = 3 * (1 - 3 * b + 3 * c) * l * l + 2 * (3 * b - 6 * c) * l + 3 * c; if (n === 0) break; var m = a(l, c, b) - k; var l = l - m / n; }k = l; } else if (n
=== 0)k = l; else { var l = h; var h = h + .1; var g = 0; do m = l + (h - l) / 2, n = a(m, c, b) - k, n > 0 ? h = m : l = m; while (Math.abs(n) > 1e-7 && ++g < 10);k = m; } return a(k, d, f);
        };
      }
    };
  })(); var Q = (function() {
    function a(a, b) { return a === 0 || a === 1 ? a : -Math.pow(2, 10 * (a - 1)) * Math.sin(2 * (a - 1 - b / (2 * Math.PI) * Math.asin(1)) * Math.PI / b); } var c = 'Quad Cubic Quart Quint Sine Expo Circ Back Elastic'.split(' '); var d = { In   : [[.55, .085, .68, .53], [.55, .055, .675, .19], [.895, .03, .685, .22], [.755, .05, .855, .06], [.47, 0, .745, .715], [.95, .05, .795, .035], [.6, .04, .98, .335], [.6, -.28, .735, .045], a], Out  : [[.25,
      .46, .45, .94], [.215, .61, .355, 1], [.165, .84, .44, 1], [.23, 1, .32, 1], [.39, .575, .565, 1], [.19, 1, .22, 1], [.075, .82, .165, 1], [.175, .885, .32, 1.275], function(b, c) { return 1 - a(1 - b, c); }], InOut: [[.455, .03, .515, .955], [.645, .045, .355, 1], [.77, 0, .175, 1], [.86, 0, .07, 1], [.445, .05, .55, .95], [1, 0, 0, 1], [.785, .135, .15, .86], [.68, -.55, .265, 1.55], function(b, c) { return b < .5 ? a(2 * b, c) / 2 : 1 - a(-2 * b + 2, c) / 2; }] }; var b = { linear: A(.25, .25, .75, .75) }; var f = {}; var e; for (e in d) {
